...
def _mss_varies(couple, criterion, _bins, max_depth, msl):
    ...
    dir_path = 'Overlaps_accuracy/' + ds_name + '/' + 'min_sample_split_varies/'
    try:
        os.makedirs(dir_path, exist_ok=True)
    except OSError as error:
        print(error)
...
def _msl_varies(couple, criterion, _bins, max_depth, mss):
    ...
    dir_path = 'Overlaps_accuracy/' + ds_name + '/' + 'min_sample_leaf_varies/'
    try:
        os.makedirs(dir_path, exist_ok=True)
    except OSError as error:
        print(error)
